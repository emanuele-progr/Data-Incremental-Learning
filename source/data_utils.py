...
class TinyImageNet(Dataset):
   """Class to manage TinyImageNet dataset"""
...
# function to rearrange tinyImageNet validation data
...
# functions to split TinyImageNet dataset, standard and joint incremental
...
# functions to split cifar10, standard and joint incremental
...
def get_split_cifar10_tasks_joint(num_tasks, batch_size):
...
# functions to split cifar100, standard, joint incremental, augmentation and linear exemplar memory
